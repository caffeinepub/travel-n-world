...
export class Backend implements backendInterface {
    ...
    async getAllNewsletterSubscriptions(): Promise<Array<NewsletterSubscription>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllNewsletterSubscriptions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPartnerRegistrations(): Promise<Array<PartnerRegistration>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPartnerRegistrations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitPartnerRegistration(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPartnerRegistration(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
